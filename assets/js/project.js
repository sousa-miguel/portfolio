...
const projects = [
  {
    title: 'Natours',
    cardImage: 'assets/images/project-page/natours.png',
    description: 'Natours | Exciting tours for adventurous people',
    tagimg: 'https://nodejs.org/static/images/logo.svg',
    Previewlink: 'https://natours-sousa.herokuapp.com/',
    Githublink: 'https://github.com/sousa-miguel/natours-v2',
  },
  {
    title: 'Forkify',
    cardImage: 'assets/images/project-page/forkify.png',
    description: 'Forkify // Search over 1,000,000 recipes',
    tagimg:
      'https://www.vhv.rs/dpng/d/456-4562295_library-of-javascript-icon-graphic-freeuse-png-files.png',
